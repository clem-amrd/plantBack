...
-- Listage de la structure de la base pour graine
CREATE DATABASE IF NOT EXISTS `graine` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `graine`;
...
-- Listage des données de la table graine.my_plants : ~12 rows (environ)
...
-- Listage des données de la table graine.personal_access_tokens : ~6 rows (environ)
...
-- Listage des données de la table graine.plants_users : ~7 rows (environ)
...
-- Listage des données de la table graine.users : ~9 rows (environ)
